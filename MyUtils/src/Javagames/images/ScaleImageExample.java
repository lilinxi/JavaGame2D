...
public class ScaleImageExample extends SimpleFramework {
    ...
    protected void initialize() {
        ...
        nearestSpeed = (end - start) / 1.0E6;//毫秒
        nearestSpeed /= 100;
    ...
    protected void render(Graphics g) {
        ...
        g.drawString("Nearest2", imgPos, textPos + 15);
        g.drawString(time, imgPos, textPos + 30);
        //Bilinear Image
        imgPos = (sw + 50) * 3 + 50;
    ...
    private void generateAveragedInstance() {
        //第一种方法使用getScaledInstance(),很慢，并且返回Image而不是BufferedImage
        //
        //
        ...
        //                               int hints)
        // 创建此图像的缩放版本。
        // 返回一个新的 Image 对象，默认情况下，该对象按指定的 width 和 height 呈现图像。
    ...
    private BufferedImage scaleWithGraphics(Object hintValue) {
        //第二种方法使用了Graphics对象，缩小到原来的一半以下时，不管使用何种插值方法，效果都很差
